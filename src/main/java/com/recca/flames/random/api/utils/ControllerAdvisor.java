package com.recca.flames.random.api.utils;
...
public class ControllerAdvisor {
    ...
    @ExceptionHandler(SecureRandomException.class)
    public ResponseEntity<?> handleRandomIntGeneratorException(SecureRandomException ex, WebRequest request) {
        return prepareResponseEntity(ex, request, HttpStatus.BAD_REQUEST);
    }
